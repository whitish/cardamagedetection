...
from tfboard_validation.custom_tensorboardx_writer import CustomTensorboardXWriter
...
class MyTrainerAugmented(DefaultTrainer):
    @classmethod
    def build_train_loader(cls, cfg):
        """
        ...
        augmentations = [
            T.RandomFlip(),
            T.RandomRotation(angle=[0, 90], sample_style="range"),
